    ...
    return {
        ...
        "ai_interpretation_contract": {
            ...
            "instructions": [
                ...
                "Treat deterministic findings and remediation as authoritative; never alter, contradict, or supplement them with invented deficiencies.",
                ...
                "Limit analysis to basic IPv6 deployment capability and configuration readiness as assessed by IPv6 Readiness Checklist v1.0.",
                "Do not recommend remediation for a deficiency unless a deterministic finding directly supports it.",
                "Every detected_deficiency recommendation must cite one or more directly supporting deterministic finding IDs.",
                "Include a best_practice recommendation only when directly relevant to the assessed technical IPv6 deployment scope, and never imply that an unassessed area has a deficiency.",
                "Do not recommend application migration, service migration, DNS migration, security controls, monitoring, organizational or process maturity, procurement, or IPv6 address planning unless deterministic evidence or findings explicitly concern that subject.",
                "Do not invent missing requirements, interfaces, protocols, topology, or operational deficiencies.",
                "When IPV6-09 is the only detected issue, focus primarily on verifying the affected interface operational state and link condition.",
